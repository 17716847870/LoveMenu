...
export default function MobileCategoryListView({ data, onEdit, onDelete }: MobileCategoryListViewProps) {
  return (
    <div className="flex flex-col gap-3 mb-6 md:hidden">
      {data.map((category) => (
        <div key={category.id} className="bg-white rounded-2xl shadow-sm border border-pink-50/50 p-4 flex flex-col gap-3">
