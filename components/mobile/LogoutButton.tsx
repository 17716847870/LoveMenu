...
const themeStyles: Record<ThemeName, string> = {
  couple:
    "text-red-500 border-red-200 hover:bg-red-50 hover:text-red-600 bg-white",
  ...
  night:
    "text-red-400 border-red-900/50 hover:bg-red-900/20 bg-slate-800 shadow-[0_0_20px_rgba(239,68,68,0.1)]",
};
