...
import { ChevronRight, History, Sparkles, Zap, Clock } from "lucide-react";
...
> = {
  ...
  night: {
    container:
      "bg-slate-900 border-slate-800 shadow-[0_0_15px_rgba(96,165,250,0.15)]",
      ...
      <div className="flex flex-col gap-3">
        {isLoading ? (
          ...
          orders.map((order, index) => (
            <OrderItemCard key={order.id} order={order} index={index} />
          ))
        ) : (
          <div
            className={cn(
