...
export default function TodayRecommendCard({ data = defaultData }: TodayRecommendCardProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className={cn("text-sm font-medium text-center", currentTheme.reason)}>
          推荐原因：{data.reason}
        </div>
