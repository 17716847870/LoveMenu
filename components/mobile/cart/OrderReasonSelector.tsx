...
const reasons = ["宝贝想吃", "我想吃", "纪念日", "夜宵", "看电影", "随便吃点"];
...
> = {
  couple: {
    ...
    input:
      "bg-white border-pink-200 focus:border-pink-500 focus:ring-pink-200 text-pink-900 placeholder:text-pink-300",
    confirmBtn:
  ...
  cute: {
    ...
    btnActive:
      "bg-orange-400 text-white border-orange-400 shadow-[2px_2px_0px_0px_rgba(251,146,60,0.5)]",
    input:
      "bg-white border-2 border-orange-200 focus:border-orange-400 focus:ring-orange-100 text-orange-900 rounded-xl",
    confirmBtn:
  ...
  minimal: {
    ...
    input:
      "bg-white border-gray-300 focus:border-black focus:ring-gray-200 text-gray-900 rounded-lg",
  ...
  night: {
    ...
    input:
      "bg-slate-800 border-slate-700 focus:border-purple-500 focus:ring-purple-500/20 text-white rounded-xl placeholder:text-slate-500",
    confirmBtn:
      "bg-gradient-to-r from-purple-600 to-blue-600 text-white shadow-purple-900/50 rounded-xl",
  },
};

export default function OrderReasonSelector({
  isOpen,
  onClose,
  onConfirm,
  isLoading,
}: OrderReasonSelectorProps) {
