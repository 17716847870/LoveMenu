...
const themeStyles: Record<
  ThemeName,
  { panel: string; tab: string; activeTab: string }
> = {
  couple: {
    panel: "bg-white border-t border-pink-100",
    tab: "text-gray-400",
    activeTab: "text-pink-500 border-b-2 border-pink-500",
  },
  cute: {
    panel: "bg-white border-t border-orange-100",
    tab: "text-gray-400",
    activeTab: "text-orange-500 border-b-2 border-orange-500",
  },
  minimal: {
    panel: "bg-white border-t border-gray-100",
    tab: "text-gray-400",
    activeTab: "text-gray-900 border-b-2 border-gray-900",
  },
  night: {
    panel: "bg-slate-900 border-t border-slate-800",
    tab: "text-slate-500",
